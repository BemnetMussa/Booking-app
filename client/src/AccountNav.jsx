...
export default function AccountNav() {
  ...
  function linkClasses(path) {
    ...
    if (currentPath === path) {
      classes += " bg-primary text-white";  // Highlight the active link
    } else {
      classes += " bg-gray-200";  // Default style
    }
  ...
  return (
    <nav className="w-full flex justify-center mt-8 mb-8 gap-2">
      ...
      <Link className={linkClasses('/account/bookings')} to={'/account/bookings'}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
